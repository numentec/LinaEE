...
INSERT INTO `auth_group` VALUES (3,'Bodega'),(5,'Contabilidad'),(4,'Gerencia'),(1,'Ventas'),(2,'Ventas Admin');
...
INSERT INTO `auth_group_permissions` VALUES (5,1,21),(1,1,24),(7,1,54),(10,1,55),(9,1,62);
...
INSERT INTO `core_user_groups` VALUES (1,2,1),(24,3,2),(25,4,1),(2,28,1),(3,28,3),(11,29,1),(4,29,2),(12,29,3),(5,29,4),(6,30,1),(7,30,3),(8,30,5),(9,31,4),(10,31,5),(13,32,1),(14,32,3),(15,33,2),(16,33,3),(17,34,1),(18,34,4),(19,35,1),(20,35,5),(21,36,2),(22,36,4),(23,36,5);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(8,'authtoken','token'),(9,'authtoken','tokenproxy'),(4,'contenttypes','contenttype'),(6,'core','cia'),(10,'core','gensequence'),(12,'core','stakeholder'),(11,'core','tipogenerico'),(7,'core','user'),(5,'sessions','session');
...
DROP TABLE IF EXISTS `lina_core_cia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `lina_core_cia`
--

LOCK TABLES `lina_core_cia` WRITE;
/*!40000 ALTER TABLE `lina_core_cia` DISABLE KEYS */;
INSERT INTO `lina_core_cia` VALUES (1,'cia01','Cia de Prueba Uno','CiaUno','100000-10-000001','11','Margarita, Cristobal','cia01@numentec.net','http://cia01.numen.com','4412587','','','','','images/no_image.png','','numencli','PA',1,'2020-10-16 01:21:04.035555','2020-10-16 01:21:04.035596',NULL),(2,'cia02','Cia de Prueba Dos','CiaDos','200000-20-000002','02','Vía Brasil, Panamá','cia02@numentec.net','http://cia02.numen.com','67163581','','','','','images/no_image.png','','numencli02','PA',1,'2020-10-16 01:22:24.668436','2020-10-16 01:22:24.668530',NULL);
/*!40000 ALTER TABLE `lina_core_cia` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `lina_core_gensequence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `lina_core_gensequence`
--

LOCK TABLES `lina_core_gensequence` WRITE;
/*!40000 ALTER TABLE `lina_core_gensequence` DISABLE KEYS */;
/*!40000 ALTER TABLE `lina_core_gensequence` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `lina_core_stakeholders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `lina_core_tipo_generico`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `lina_core_tipo_generico`
--

LOCK TABLES `lina_core_tipo_generico` WRITE;
/*!40000 ALTER TABLE `lina_core_tipo_generico` DISABLE KEYS */;
INSERT INTO `lina_core_tipo_generico` VALUES (1,1,'2020-12-01 23:59:28.519823','2020-12-01 23:59:28.519884','CR1','CREDITO TIPO1',NULL,NULL);
/*!40000 ALTER TABLE `lina_core_tipo_generico` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-01-19  1:25:44
